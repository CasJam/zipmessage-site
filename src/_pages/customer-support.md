...
<div class="relative pt-16 pb-64 px-8 text-center flex flex-col justify-center items-center bg-gradient-to-b from-brand-light-blue-200 to-brand-light-blue-300
  ...
  <span class="flex items-center text-brand-light-blue-600 font-medium italic inline-block py-1 px-4 ring-2 ring-brand-light-blue-500 rounded-full text-base mb-8 
               md:text-lg">
    <svg class="w-5 h-5 mr-3 text-brand-light-blue-600 relative top-1px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 768 768" stroke="currentColor" fill="currentColor">
    ...
    <span>For better customer support</span>
  </span>
  ...
  <h1 class="text-4xl mb-6 font-brand font-medium tracking-tight
    ...
    Let customers send you their screen recordings. Zero friction.
  </h1>
  ...
  <p class="text-xl text-brand-blue-400 weight-medium mx-auto
            ...
            lg:w-2/3 
            xl:w-1/2">
    The easiest way to ask customers to send you their screen recordings so you can resolve their support issue efficiently.
  </p>
