    ...
    <div class="max-w-6xl mx-auto pb-20 px-8 
      ...
      <%= link_to "#", 
                  class: "flex mb-2 p-6  rounded-md
                          hover:bg-brand-blue-200 hover:bg-opacity-10" do %> 
        <div class="mr-6">
...
<%= render "static/landing-page-blocks/integrations" %>

<%= render "static/landing-page-blocks/end-cta" %>

<%= render "static/footer" %>

<%= render "static/early_access_modal" %>
