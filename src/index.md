...
<!-- Hero -->
<div class="relative pt-16 pb-64 px-8 text-center flex flex-col justify-center bg-gradient-to-b from-brand-light-blue-200 to-brand-light-blue-300
  ...
  <svg class="hidden 
              absolute -bottom-12 right-14 z-50 text-brand-blue-400 opacity-10 transform rotate-12 
              lg:block lg:w-80 lg:h-80 
              2xl:w-30rem 2xl:h-30rem" viewBox="0 0 714 554" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" stroke="currentColor" fill="currentColor">
...
<div class="bg-brand-blue-500 w-full z-50 relative -top-3px">
  ...
  <div class="relative 
    ...
    <div class="text-center mb-16 pt-12
              md:pt-0 md:mb-28
              lg:text-left lg:mx-16 lg:mb-24
              xl:mx-auto xl:text-center xl:max-w-7xl">
    
      <h2 class="text-3xl mb-4 font-brand text-brand-blue-50 font-medium
                 md:text-5xl 
                 lg:text-6xl">
        <span class="italic">&ldquo;Let's have more Zoom calls.&rdquo;</span><br />
        <span class="text-2xl 
                     md:text-4xl 
                     lg:text-5xl">&mdash;Says no one, ever.</span>
      </h2>

      <p class="px-8 text-lg text-brand-blue-300 weight-medium
                md:text-2xl md:w-3/4 md:mx-auto 
                lg:w-2/3 lg:mx-0 lg:px-0 
                xl:w-1/2 xl:mx-auto">
        When you need the clarity of video & screen-sharing,  without the &ldquo;Zoom-fatigue&rdquo;, use ZipMessage.
      </p>

    </div>

    <div class="max-w-6xl mx-auto pb-20 px-8 
                md:mx-0 md:grid md:gap-x-4 md:gap-y-2 md:grid-cols-2 
                lg:gap-y-8 lg:pb-16
                xl:md-gap-x-24 xl:mx-auto xl:px-1 xl:gap-x-20 xl:pb-20">
      
      <a href="/customer-support" 
         class="flex mb-2 p-6  rounded-md
                hover:bg-brand-blue-200 hover:bg-opacity-10">
        <div class="mr-6">
          <svg class="w-7 h-7 text-brand-light-blue-500 relative top-1px
        ...
        <div class="flex-1">
          <h3 class="text-brand-light-blue-500 font-medium text-2xl mb-2 
                     lg:text-2xl">For video customer support</h3>
          <p class="text-xl text-brand-blue-300 
                    lg:w-3/4 
                    xl:w-full">Customers can share their screen <span class="italic">without live Zoom calls</span>. 
          <svg class="w-5 h-5 text-brand-light-blue-500 inline-block relative -top-2px" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 9l3 3m0 0l-3 3m3-3H8m13 0a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg></p>
        </div>
      </a>

      <a href="/video-recruiting-software" 
         class="flex mb-2 p-6  rounded-md
                hover:bg-brand-blue-200 hover:bg-opacity-10">
        <div class="mr-6">
          <svg class="w-7 h-7 text-brand-red-500
                      lg:w-8 lg:h-8" version="1.1" xmlns="http://www.w3.org/2000/svg" width="768" height="768" viewBox="0 0 768 768" stroke="currentColor" fill="currentColor">
        ...
        <div class="flex-1">
          <h3 class="text-brand-red-500 font-medium text-2xl mb-2 
                     lg:text-2xl">For hiring interviews</h3>
          <p class="text-xl text-brand-blue-300 
                    lg:w-3/4 
                    xl:w-full">Screen candidates&rsquo; responses before <span class="italic">before committing to live interviews</span>. 
          <svg class="w-5 h-5 text-brand-red-500 inline-block relative -top-2px" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 9l3 3m0 0l-3 3m3-3H8m13 0a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          </p>
        </div>
      ...
      <a href="/video-coaching-software" 
         class="flex mb-2 p-6  rounded-md
                hover:bg-brand-blue-200 hover:bg-opacity-10">
        <div class="mr-6">
          <svg class="w-7 h-7 text-yellow-500
                      lg:w-8 lg:h-8" version="1.1" xmlns="http://www.w3.org/2000/svg" width="768" height="768" viewBox="0 0 768 768" stroke="currentColor" fill="currentColor">
            <path d="M80 544h608c8.8 0 16-7.2 16-16v-336c0-35.3-28.7-64-64-64h-512c-35.3 0-64 28.7-64 64v336c0 8.8 7.2 16 16 16zM320 352c0-35.3 28.7-64 64-64s64 28.7 64 64c0 35.3-28.7 64-64 64s-64-28.7-64-64zM480 512h-192v-11.5c23.1-36.3 52.9-52.5 96-52.5s72.9 16.2 96 52.5v11.5zM128 192h512v320h-128v-16c0-2.9-0.8-5.8-2.3-8.2-14.4-24-31.2-41.4-51.4-53.3-4.7-2.8-9.6-5.2-14.6-7.4 22.1-17.6 36.3-44.7 36.3-75.1 0-52.9-43.1-96-96-96s-96 43.1-96 96c0 30.4 14.2 57.5 36.3 75.1-5 2.1-9.9 4.6-14.6 7.4-20.2 11.9-37 29.3-51.4 53.3-1.5 2.5-2.3 5.3-2.3 8.2v16h-128v-320z"></path>
            <path d="M0 576h768v64h-768v-64z"></path>
          </svg>

        </div>
        <div class="flex-1">
          <h3 class="text-yellow-500 font-medium text-2xl mb-2 
                     lg:text-2xl">For coaches &amp; teachers</h3>
          <p class="text-xl text-brand-blue-300 
                    lg:w-3/4 
                    xl:w-full">Work with students &amp; clients on video <span class="italic">without the calendar chaos</span>. 
          <svg class="w-5 h-5 text-yellow-500 inline-block relative -top-2px" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 9l3 3m0 0l-3 3m3-3H8m13 0a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg></p>
        </div>
      </a>

      <a href="/remote-video-messaging-software" 
         class="flex mb-2 p-6  rounded-md
                hover:bg-brand-blue-200 hover:bg-opacity-10">
        <div class="mr-6">
          <svg class="w-7 h-7 text-green-500
                      lg:w-8 lg:h-8" version="1.1" xmlns="http://www.w3.org/2000/svg" width="768" height="768" viewBox="0 0 768 768" stroke="currentColor" fill="currentColor">
        ...
        <div class="flex-1">
          <h3 class="text-green-500 font-medium text-2xl mb-2 
                     lg:text-2xl">For remote teams</h3>
          <p class="text-xl text-brand-blue-300 
                    lg:w-3/4 
                    xl:w-4/5">1-on-1s, standups, and group calls <span class="italic">without disruptive meetings.</span> 
            <svg class="w-5 h-5 text-green-500 inline-block relative -top-2px" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 9l3 3m0 0l-3 3m3-3H8m13 0a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg></p>
        </div>
      </a>
...
<div class="bg-gradient-to-b to-brand-light-blue-300 from-white text-center pb-20 px-8 relative -top-2px 
  ...
  <!-- <a href="#" 
     class="btn btn-primary italic text-xl py-8 px-10 mb-12">
    Try it free
  </a> -->
  ...
  <!-- <div class="space-y-6 text-xl font-medium 
              md:space-y-0 md:space-x-12 md:flex md:justify-center md:w-full md:mx-auto">
    ...
    <a href="#" 
      ...
      <span>See a demo &amp; ask questions</span>
      <span class="block text-base italic text-brand-blue-300">(using ZipMessage!)</span>
    </a>
